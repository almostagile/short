...
/**
 * @method connect
 * @param {String} mongodb Mongo DB URI to connect to
 * @param {Object} [options] Optional connection options to pass to the driver
 */

exports.connect = function(mongodb, options) {
